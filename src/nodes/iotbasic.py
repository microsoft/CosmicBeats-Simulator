...
class IoTBasic(INode):
    '''
    This class implements basic IoT functionalities.
    It inherits INode interface
    '''
    __nodetype = ENodeType.IOTDEVICE
    __nodeid: int
    __topologyid: int
    __position: Location
    ...
    def add_Models(
        ...
        for _model in _modelsToAdd:
            self.__tagToModel[_model.modelTag] = _model
    ...
    def has_ModelWithTag(
        ...
        @return
            ...
            Otherwise, None 
        """       
        return self.__tagToModel.get(_modelTag, None)
    ...
    def update_Position(
        ...
        @desc
            ...
            As we are considering it as a static IoT implementation, we don't expect time in the argument.
    ...
    def __init__(
        ...
        self.__endTimeStamp = _endtime.copy()
        self.__logger = _Logger
        self.__models = []
        
        self.__lat, self.__lon, self.__alt = _location.to_lat_long() #Saves us from calling the function again and again
        self.__tagToModel = {}
    ...
    def __str__(self):
        ...
        _nodeDetails = "".join(["IoT node ID:: ", str(self.__nodeid), ", ",
